...
if __name__ == "__main__":
    ...
    # url = "https://uo-db-api.herokuapp.com/uo/users",
    #all_results_list = [x async for x in self.get_paged_results(url, session)]
    #print(f"Length of all results {len(all_results_list}")
